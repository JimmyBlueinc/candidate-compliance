  ...
  return (
    <section className="relative grid lg:grid-cols-2 gap-16 items-center">
      <div className="space-y-8 z-10">
        <h1 className="serif text-5xl md:text-7xl leading-[1.1] text-gradient">
          Elite Compliance for Healthcare Staffing Agencies.
        </h1>
        <p className="text-gray-400 text-lg md:text-xl max-w-xl leading-relaxed">
          Embracing the "Goodwill Staffing" philosophy, we track every detail of your medical personnel to ensure excellence and trust.
        </p>
        
        <div className="flex flex-wrap gap-4 pt-4">
          <button className="px-8 py-4 bg-white text-black font-semibold rounded-full hover:bg-purple-50 transition-all shadow-xl shadow-purple-500/10">
