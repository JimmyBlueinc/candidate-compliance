...
class WorkAuthorizationController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->api($workAuthorizations, 200, [], 'Work authorizations retrieved successfully');
    }
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        return response()->api($workAuthorization, 201, [], 'Work authorization created successfully');
    }
    ...
    public function show(Request $request, WorkAuthorization $workAuthorization): JsonResponse
    {
        ...
        return response()->api($workAuthorization, 200, [], 'Work authorization retrieved successfully');
    }
    ...
    public function update(Request $request, WorkAuthorization $workAuthorization): JsonResponse
    {
        ...
        return response()->api($workAuthorization->fresh(), 200, [], 'Work authorization updated successfully');
    }
    ...
    public function destroy(Request $request, WorkAuthorization $workAuthorization): JsonResponse
    {
        ...
        return response()->api(null, 200, [], 'Work authorization deleted successfully');
    }
}
