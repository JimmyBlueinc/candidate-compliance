...
@section('preview', 'Your organization ' . $organizationName . ' is ready on AgencHQ')
...
@section('content')
    ...
    <p style="margin: 0 0 24px; font-size: 16px; color: #6b7280;">
        <strong style="color: #111827;">{{ $organizationName }}</strong> is now set up on AgencHQ.
    </p>
    ...
    <p style="margin: 0; font-size: 15px; color: #374151; line-height: 1.6;">
        After signing in, you'll complete onboarding by choosing your subdomain, uploading your logo, and setting your brand color.
    </p>
@endsection
...
@section('footer_text', 'You received this email because you signed up for AgencHQ.')
