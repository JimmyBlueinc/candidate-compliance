...
return new class extends Migration
{
    public function up(): void
    {
        ...
        if (DB::getDriverName() === 'sqlite') {
            ...
            DB::statement('CREATE INDEX IF NOT EXISTS users_facility_id_index ON users_new(facility_id)');
    ...
    public function down(): void
    {
        ...
        if (DB::getDriverName() === 'sqlite') {
            ...
            DB::statement('CREATE INDEX IF NOT EXISTS users_facility_id_index ON users_old(facility_id)');
